...
int main() {
    // Test 1: Verify struct size matches the contract (128 bytes)
    ...
    header.output_offset = sizeof(SharedMemoryHeader) + 512 * sizeof(float);
    ...
    assert(header.output_offset == sizeof(SharedMemoryHeader) + 512 * 4);
