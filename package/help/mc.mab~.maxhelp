    ...
    "boxes": [
      {
        "box": {
          "maxclass": "comment",
          "text": "mc.mab~ - RAVE / AFTER TorchScript inference",
          "id": "obj-title",
          "numinlets": 1,
          "numoutlets": 0,
      ...
      },
      {
        "box": {
          "maxclass": "comment",
          "text": "Args: [mc.mab~ model.ts (method) (buffer_size) (gpu) (num_channels) (cores)]",
          "id": "obj-args",
          "numinlets": 1,
          "numoutlets": 0,
      ...
      },
      {
        "box": {
          "maxclass": "newobj",
          "text": "mc.mab~ model.ts forward 512 0 1 2",
          "id": "obj-mab",
          "numinlets": 1,
          "numoutlets": 1,
      ...
      },
      {
        "box": {
          "maxclass": "comment",
          "text": "Void mode: mc.mab~ void <inlets> <outlets> <bufsize>",
          "id": "obj-void-note",
          "numinlets": 1,
          "numoutlets": 0,
